...
class AssetData {
	...
	public static function initialize ():Void {
		...
		if (!initialized) {
			...
			className.set ("Reload", nme.NME_assets_reload_mp3);
			type.set ("Reload", Reflect.field (AssetType, "sound".toUpperCase ()));
			className.set ("Jump", nme.NME_assets_jump_mp3);
			type.set ("Jump", Reflect.field (AssetType, "sound".toUpperCase ()));
			className.set ("Click", nme.NME_assets_click_mp3);
			type.set ("Click", Reflect.field (AssetType, "sound".toUpperCase ()));
			className.set ("Bang", nme.NME_assets_bang_mp3);
			type.set ("Bang", Reflect.field (AssetType, "sound".toUpperCase ()));
			className.set ("Spawn", nme.NME_assets_spawn_mp3);
			type.set ("Spawn", Reflect.field (AssetType, "sound".toUpperCase ()));
			className.set ("gMusic", nme.NME_assets_game_music_mp3);
			type.set ("gMusic", Reflect.field (AssetType, "music".toUpperCase ()));
			className.set ("mMusic", nme.NME_assets_menu_music_mp3);
			type.set ("mMusic", Reflect.field (AssetType, "music".toUpperCase ()));
			className.set ("assets/bang.mp3", nme.NME_assets_bang_mp4);
			type.set ("assets/bang.mp3", Reflect.field (AssetType, "music".toUpperCase ()));
			...
			className.set ("assets/click.mp3", nme.NME_assets_click_mp4);
			type.set ("assets/click.mp3", Reflect.field (AssetType, "music".toUpperCase ()));
			...
			className.set ("assets/data/beep.mp3", nme.NME_assets_data_beep_mp3);
			...
			className.set ("assets/game_music.mp3", nme.NME_assets_game_music_mp4);
			type.set ("assets/game_music.mp3", Reflect.field (AssetType, "music".toUpperCase ()));
			...
			className.set ("assets/jump.mp3", nme.NME_assets_jump_mp4);
			type.set ("assets/jump.mp3", Reflect.field (AssetType, "music".toUpperCase ()));
			className.set ("assets/map.png", nme.NME_assets_map_png);
			type.set ("assets/map.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/menu_music.mp3", nme.NME_assets_menu_music_mp4);
			type.set ("assets/menu_music.mp3", Reflect.field (AssetType, "music".toUpperCase ()));
			...
			className.set ("assets/reload.mp3", nme.NME_assets_reload_mp4);
			type.set ("assets/reload.mp3", Reflect.field (AssetType, "music".toUpperCase ()));
			className.set ("assets/spawn.mp3", nme.NME_assets_spawn_mp4);
			type.set ("assets/spawn.mp3", Reflect.field (AssetType, "music".toUpperCase ()));
			...
			className.set ("assets/zombie.png", nme.NME_assets_zombie_png);
			type.set ("assets/zombie.png", Reflect.field (AssetType, "image".toUpperCase ()));
...
class NME_assets_reload_mp3 extends flash.media.Sound { }
class NME_assets_jump_mp3 extends flash.media.Sound { }
class NME_assets_click_mp3 extends flash.media.Sound { }
class NME_assets_bang_mp3 extends flash.media.Sound { }
class NME_assets_spawn_mp3 extends flash.media.Sound { }
class NME_assets_game_music_mp3 extends flash.media.Sound { }
class NME_assets_menu_music_mp3 extends flash.media.Sound { }
class NME_assets_bang_mp4 extends flash.media.Sound { }
class NME_assets_bullet_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_click_mp4 extends flash.media.Sound { }
...
class NME_assets_game_music_mp4 extends flash.media.Sound { }
class NME_assets_haxeflixel_svg extends flash.utils.ByteArray { }
class NME_assets_jump_mp4 extends flash.media.Sound { }
class NME_assets_map_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_menu_music_mp4 extends flash.media.Sound { }
class NME_assets_player_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_reload_mp4 extends flash.media.Sound { }
class NME_assets_spawn_mp4 extends flash.media.Sound { }
class NME_assets_tiles_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_zombie_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
